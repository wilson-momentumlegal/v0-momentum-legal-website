...
import { ArrowRight, Scale, FileText, Shield, Building2, Calculator, Target, Menu, X, ArrowLeft } from "lucide-react"
import { 
  fadeUp, 
  stagger, 
  staggerFast,
...
export default function NILAthletePage() {
  ...
  const services = [
    {
      title: "NIL Contract Review & Negotiation",
      description: "Endorsements, sponsorships, appearances, social media deals.",
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: "Brand & IP Protection",
      description: "Trademark filings, publicity rights, licensing deals.",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "Business Formation for Athletes",
      description: "LLCs or S-corps for NIL income management.",
      icon: <Building2 className="h-6 w-6" />
    },
    {
      title: "Tax & Compliance Guidance",
      description: "1099 vs W-2 considerations, NCAA/CSC compliance alignment.",
      icon: <Calculator className="h-6 w-6" />
    },
    {
      title: "Long-Term Planning",
      description: "Transitioning from college NIL to professional contracts, equity stakes, and royalties.",
      ...
      >
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          >
            ...
            >
              <strong>Clients:</strong> Student-athletes, professional athletes, families.
            </motion.p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              <motion.h2 
                ...
                whileTap={isMobile ? { scale: 0.98 } : undefined}
              >
                Our NIL & Athlete Services
              </motion.h2>
              <motion.p 
                className="text-lg sm:text-2xl text-gray-600 max-w-4xl mx-auto text-pretty font-light leading-relaxed"
                variants={isMobile ? mobileTextReveal : textReveal}
              >
                Comprehensive legal support for athletes navigating the complex world of Name, Image, and Likeness opportunities.
              </motion.p>
            </motion.div>
        ...
        <section className="py-24 bg-black relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-2xl text-white/90 mb-12 text-pretty font-light leading-relaxed">
              Schedule a free consultation with our legal experts and take the first step toward protecting and maximizing your Name, Image, and Likeness opportunities.
            </p>
