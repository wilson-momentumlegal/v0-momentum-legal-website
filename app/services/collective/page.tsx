...
import { ArrowRight, Scale, Building2, Shield, FileText, Users, Search, Menu, X, ArrowLeft } from "lucide-react"
import { 
  fadeUp, 
  stagger, 
  staggerFast,
  ...
  const services = [
    {
      ...
      description: "For-profit vs nonprofit, tax strategy, governance",
      icon: <Building2 className="h-6 w-6" />
    },
    {
      title: "Compliance Policies",
      description: "NIL rule navigation, NCAA & CSC regulatory alignment",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "Contract Infrastructure",
      description: "Templates for athlete deals, donor agreements, sponsorship partnerships",
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: "Ongoing Legal Counsel",
      description: "Monthly retainer for compliance monitoring, contract drafting, and governance updates",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "Audits & Risk Reviews",
      description: "Annual compliance audits for donor reassurance and institutional credibility",
      ...
      >
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          >
            ...
            >
              <strong>Clients:</strong> NIL collectives, donor groups, alumni-backed organizations.
            </motion.p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <motion.p 
                ...
                variants={isMobile ? mobileTextReveal : textReveal}
              >
                Comprehensive legal support for NIL collectives, donor groups, and alumni-backed organizations navigating the evolving NIL landscape.
              </motion.p>
            </motion.div>
        ...
        <section className="py-24 bg-black relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-2xl text-white/90 mb-12 text-pretty font-light leading-relaxed">
              Schedule a free consultation with our legal experts and take the first step toward establishing a compliant and successful NIL collective.
            </p>
