...
import { ArrowRight, Scale, Building2, TrendingUp, FileText, Users, Shield, Menu, X, ArrowLeft } from "lucide-react"
import { 
  fadeUp, 
  stagger, 
  staggerFast,
...
export default function CorporateVenturePage() {
  ...
  const services = [
    {
      ...
      description: "LLCs, C-Corps, partnerships, governance docs.",
      icon: <Building2 className="h-6 w-6" />
    },
    {
      title: "Venture Financings",
      description: "Representing VC funds and startups in seed, Series A+, and growth rounds.",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "M&A Transactions",
      description: "Buy-side and sell-side legal counsel for acquisitions, joint ventures, asset sales.",
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: "Commercial Contracts",
      description: "Licensing agreements, distribution deals, service agreements.",
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: "Employment & Equity Matters",
      description: "Executive contracts, stock options, ESOP plans.",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "Compliance & Risk Advisory",
      description: "Regulatory strategy, securities compliance, risk mitigation.",
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          >
            ...
            >
              ...
              >
                1. Corporate & Venture Transactions
              </motion.span>
            </motion.h1>
            ...
            >
              <strong>Clients:</strong> VC funds, startups, growth companies, brands.
            </motion.p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              <motion.h2 
                ...
                whileTap={isMobile ? { scale: 0.98 } : undefined}
              >
                Our Corporate & Venture Services
              </motion.h2>
              <motion.p 
                className="text-lg sm:text-2xl text-gray-600 max-w-4xl mx-auto text-pretty font-light leading-relaxed"
                variants={isMobile ? mobileTextReveal : textReveal}
              >
                Comprehensive legal support for venture capital funds, startups, and growth companies navigating complex business transactions.
              </motion.p>
            </motion.div>
            ...
            >
              {services.map((service, index) => {
                const colors = [
                  ...
                  { bg: 'purple-500/5', border: 'purple-200/30', icon: 'text-purple-700', glow: 'purple-500/20' }
                ][index]
        ...
        <section className="py-24 bg-black relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-2xl text-white/90 mb-12 text-pretty font-light leading-relaxed">
              Schedule a free consultation with our legal experts and take the first step toward creating lasting growth in the corporate and venture ecosystem.
            </p>
